...
//    ),
    ...
    DatabaseType(String urlPrefix, String urlSplit, String driverName, String params,DSGConfig.ConfVars userName, DSGConfig.ConfVars password, DSGConfig.ConfVars host, DSGConfig.ConfVars port) {
