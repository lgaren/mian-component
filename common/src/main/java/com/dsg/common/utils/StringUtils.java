...
//
	...
	// Constants.EMPTY checks
	// -----------------------------------------------------------------------
	/**
	 * <p>
	 * Checks if a CharSequence is Constants.EMPTY ("") or null.
	 * </p>
	 *
	 * <pre>
	 ...
	 * @return {@code true} if the CharSequence is Constants.EMPTY or null
	 */
	...
	/**
	 * <p>
	 * Checks if a CharSequence is not Constants.EMPTY ("") and not null.
	 * </p>
	 *
	 * <pre>
	 ...
	 * @param cs
	 *            the CharSequence to check, may be null
	 * @return {@code true} if the CharSequence is not Constants.EMPTY and not null
	...
	/**
	 * <p>
	 * Checks if any one of the CharSequences are Constants.EMPTY ("") or null.
	 * </p>
	 *
	 * <pre>
	 ...
	 *
	 * @param css
	 *            the CharSequences to check, may be null or Constants.EMPTY
	 * @return {@code true} if any of the CharSequences are Constants.EMPTY or null
	 * @since 3.2
	 */
	...
	/**
	 * <p>
	 * Checks if none of the CharSequences are Constants.EMPTY ("") or null.
	 * </p>
	 *
	 * <pre>
	 ...
	 * @param css
	 *            the CharSequences to check, may be null or Constants.EMPTY
	 * @return {@code true} if none of the CharSequences are Constants.EMPTY or null
	 * @since 3.2
	 */
	...
	/**
	 * <p>
	 * Checks if a CharSequence is whitespace, Constants.EMPTY ("") or null.
	 * </p>
	 *
	 * <pre>
	 ...
	 * @param cs
	 *            the CharSequence to check, may be null
	 * @return {@code true} if the CharSequence is null, Constants.EMPTY or whitespace
	 * @since 2.0
	...
	/**
	 * <p>
	 * Checks if a CharSequence is not Constants.EMPTY (""), not null and not whitespace only.
	 * </p>
	 *
	 * <pre>
	 ...
	 * @param cs
	 *            the CharSequence to check, may be null
	 * @return {@code true} if the CharSequence is not Constants.EMPTY and not null and not
	 *         whitespace
	 * @since 2.0
	 ...
	 * <p>
	 * Removes control characters (char &lt;= 32) from both ends of this String
	 * returning {@code null} if the String is Constants.EMPTY ("") after the trim or if it is
	 * {@code null}.
	 *
	 * <p>
	 * The String is trimmed using {@link String#trim()}. Trim removes start and end
	 ...
	 * @param str
	 *            the String to be trimmed, may be null
	 * @return the trimmed String, {@code null} if only chars &lt;= 32, Constants.EMPTY or
	 *         null String input
	 * @since 2.0
	 */
	 ...
	 * <p>
	 * Removes control characters (char &lt;= 32) from both ends of this String
	 * returning an Constants.EMPTY String ("") if the String is Constants.EMPTY ("") after the trim or
	 * if it is {@code null}.
	 *
	 * <p>
	 * The String is trimmed using {@link String#trim()}. Trim removes start and end
	 ...
	 * @param str
	 *            the String to be trimmed, may be null
	 * @return the trimmed String, or an Constants.EMPTY String if {@code null} input
	 * @since 2.0
	 */
	public static String trimToEmpty(final String str) {
		return str == null ? Constants.EMPTY : str.trim();
	}
	 ...
	 * if the String is Constants.EMPTY ("") after the strip.
	 * </p>
	 *
	 * <p>
	 ...
	 * @return the stripped String, {@code null} if whitespace, Constants.EMPTY or null String
	 *         input
	 * @since 2.0
	 */
	...
	/**
	 * <p>
	 * Strips whitespace from the start and end of a String returning an Constants.EMPTY
	...
	public static String stripToEmpty(final String str) {
		return str == null ? Constants.EMPTY : strip(str, null);
	}
	 ...
	 *
	 * <p>
	 * A {@code null} input String returns {@code null}. An Constants.EMPTY string ("") input
	 * returns the Constants.EMPTY string.
	 * </p>
	 *
	 * <p>
	...
	public static String stripStart(final String str, final String stripChars) {
		...
		if (stripChars == null) {
			...
			while (start != strLen && stripChars.indexOf(str.charAt(start)) != Constants.INDEX_NOT_FOUND) {
				start++;
			}
		}
	...
	public static String stripEnd(final String str, final String stripChars) {
		...
		if (stripChars == null) {
			...
			while (end != 0 && stripChars.indexOf(str.charAt(end - 1)) != Constants.INDEX_NOT_FOUND) {
				end--;
			}
		}
	 ...
	 * array will return {@code null}. An Constants.EMPTY array will return itself. A
	...
	public static String stripAccents(final String input) {
		...
		return pattern.matcher(decomposed).replaceAll(Constants.EMPTY);
	}
	 ...
	 *
	 * <p>
	 * A {@code null} or Constants.EMPTY ("") CharSequence will return
	 * {@code Constants.INDEX_NOT_FOUND (-1)}.
	 * </p>
	 *
	 * <pre>
	 ...
	 * is treated as zero. An Constants.EMPTY ("") search CharSequence always matches. A start
	 * position greater than the string length only matches an Constants.EMPTY search
	 * CharSequence.
	 * </p>
	 *
	 * <pre>
	 ...
	 *         ({@code Constants.INDEX_NOT_FOUND}) if no match or {@code null} string input
	 * @since 2.1
	...
	private static int ordinalIndexOf(final CharSequence str, final CharSequence searchStr, final int ordinal,
		...
		int index = lastIndex ? str.length() : Constants.INDEX_NOT_FOUND;
		do {
			if (lastIndex) {
	 ...
	 *
	 * <p>
	 * A {@code null} or Constants.EMPTY ("") CharSequence will return {@code -1}.
	 * </p>
	 *
	 * <pre>
	 ...
	 *
	 * <p>
	 * A {@code null} or Constants.EMPTY ("") CharSequence will return {@code -1}. A negative
	 ...
	 * <p>
	 * A {@code null} CharSequence will return {@code -1}. A negative start position
	 * returns {@code -1}. An Constants.EMPTY ("") search CharSequence always matches unless
	 ...
	 *
	 * <p>
	 * A {@code null} or Constants.EMPTY ("") CharSequence will return {@code false}.
	 * </p>
	 *
	 * <pre>
	 ...
	 * @return {@code true} if the CharSequence is not Constants.EMPTY and contains at least 1
	 ...
	 *            The array of CharSequences to search for, may be null. Individual
	 ...
	 *
	 * <p>
	 * A {@code null} CharSequence will return {@code -1}. A {@code null} or Constants.EMPTY
	 ...
	 * character array will return {@code false}. An Constants.EMPTY CharSequence (length()=0)
	...
	public static boolean containsOnly(final CharSequence cs, final char... valid) {
		...
		return indexOfAnyBut(cs, valid) == Constants.INDEX_NOT_FOUND;
	}
	 ...
	 * <p>
	 * A {@code null} CharSequence will return {@code false}. A {@code null} valid
	 * character String will return {@code false}. An Constants.EMPTY String (length()=0)
	 * always returns {@code true}.
	 * </p>
	 *
	 * <pre>
	 ...
	 * character array will return {@code true}. An Constants.EMPTY CharSequence (length()=0)
	 * always returns true.
	 * </p>
	 *
	 * <pre>
	 ...
	 * <p>
	 * A {@code null} CharSequence will return {@code true}. A {@code null} invalid
	 * character array will return {@code true}. An Constants.EMPTY String ("") always returns
	 * true.
	 * </p>
	 *
	 * <pre>
	...
	public static int indexOfAny(final CharSequence str, final CharSequence... searchStrs) {
		...
		for (int i = 0; i < sz; i++) {
			...
			if (tmp == Constants.INDEX_NOT_FOUND) {
				continue;
			}
		...
		return ret == Integer.MAX_VALUE ? Constants.INDEX_NOT_FOUND : ret;
	}
	...
	public static int lastIndexOfAny(final CharSequence str, final CharSequence... searchStrs) {
		...
		final int sz = searchStrs.length;
		int ret = Constants.INDEX_NOT_FOUND;
		int tmp = 0;
		for (int i = 0; i < sz; i++) {
			final CharSequence search = searchStrs[i];
			if (search == null) {
	 ...
	 *
	 * <p>
	 * A {@code null} String will return {@code null}. An Constants.EMPTY ("") String will
	 * return "".
	 * </p>
	 *
	 * <pre>
	 ...
	 * the String will be returned without an exception. An Constants.EMPTY String is returned
	 * if len is negative.
	 * </p>
	 *
	 * <pre>
	 ...
	 * <p>
	 * If {@code len} characters are not available, or the String is {@code null},
	 * the String will be returned without an an exception. An Constants.EMPTY String is
	 ...
	 * will be returned. An Constants.EMPTY String is returned if len is negative or exceeds
	 ...
	 *
	 * <p>
	 * A {@code null} string input will return {@code null}. An Constants.EMPTY ("") string
	 * input will return the Constants.EMPTY string. A {@code null} separator will return the
	 * input string.
	 * </p>
	 *
	 * <p>
	...
	public static String substringBefore(final String str, final String separator) {
		...
		if (pos == Constants.INDEX_NOT_FOUND) {
			return str;
		}
	 ...
	 * A {@code null} string input will return {@code null}. An Constants.EMPTY ("") string
	 * input will return the Constants.EMPTY string. A {@code null} separator will return the
	 * Constants.EMPTY string if the input string is not {@code null}.
	 * </p>
	 *
	 * <p>
	 * If nothing is found, the Constants.EMPTY string is returned.
	 * </p>
	 *
	 * <pre>
	 ...
	 * <p>
	 * A {@code null} string input will return {@code null}. An Constants.EMPTY ("") string
	 * input will return the Constants.EMPTY string. An Constants.EMPTY or {@code null} separator will
	 ...
	 * A {@code null} string input will return {@code null}. An Constants.EMPTY ("") string
	 * input will return the Constants.EMPTY string. An Constants.EMPTY or {@code null} separator will
	 * return the Constants.EMPTY string if the input string is not {@code null}.
	 * </p>
	 *
	 * <p>
	 * If nothing is found, the Constants.EMPTY string is returned.
	...
	public static String substringAfterLast(final String str, final String separator) {
		...
		final int pos = str.lastIndexOf(separator);
		if (pos == Constants.INDEX_NOT_FOUND || pos == str.length() - separator.length()) {
			return Constants.EMPTY;
		}
		return str.substring(pos + separator.length());
	}
	 ...
	 * returns {@code null} (no match). An Constants.EMPTY ("") open and close returns an
	 ...
	 * <p>
	 * A {@code null} input String returns {@code null}. A {@code null} open/close
	 * returns {@code null} (no match). An Constants.EMPTY ("") open/close returns
	 * {@code null} (no match).
	 * </p>
	 *
	 * <pre>
	 ...
	 *
	 * @param str
	 *            the String containing the substrings, null returns null, Constants.EMPTY
	 *            returns Constants.EMPTY
	 * @param open
	 *            the String identifying the start of the substring, Constants.EMPTY returns
	 *            null
	 * @param close
	 *            the String identifying the end of the substring, Constants.EMPTY returns
	 *            null
	 ...
	 * <p>
	 * The separator is not included in the returned String array. Adjacent
	 * separators are treated as separators for Constants.EMPTY tokens. For more control over
	 ...
	 *            if {@code true}, adjacent separators are treated as Constants.EMPTY token
	...
	private static String[] splitByWholeSeparatorWorker(final String str, final String separator, final int max,
		...
		if (separator == null || Constants.EMPTY.equals(separator)) {
			// Split on whitespace.
				...
				if (end > beg) {
					...
					if (preserveAllTokens) {
						...
						if (numberOfSubstrings == max) {
							...
							substrings.add(Constants.EMPTY);
						}
					}
					beg = end + separatorLength;
				}
	 ...
	 * <p>
	 * Splits the provided text into an array, using whitespace as the separator,
	 * preserving all tokens, including Constants.EMPTY tokens created by adjacent separators.
	 ...
	 * tokens, including Constants.EMPTY tokens created by adjacent separators. This is an
	 * alternative to using StringTokenizer.
	 * </p>
	 *
	 * <p>
	 ...
	 * <p>
	 * Splits the provided text into an array with a maximum length, separators
	 * specified, preserving all tokens, including Constants.EMPTY tokens created by adjacent
	 * separators.
	 * </p>
	 *
	 * <p>
	 * The separator is not included in the returned String array. Adjacent
	 * separators are treated as separators for Constants.EMPTY tokens. Adjacent separators
	 ...
	 *
	 * <p>
	 * No separator is added to the joined String. Null objects or Constants.EMPTY strings
	 * within the array are represented by Constants.EMPTY strings.
	 * </p>
	 *
	 * <pre>
	 ...
	 *
	 * <p>
	 * No delimiter is added before or after the list. Null objects or Constants.EMPTY strings
	 * within the array are represented by Constants.EMPTY strings.
	 * </p>
	 *
	 * <pre>
...
//
	 ...
	 * the same as an Constants.EMPTY String (""). Null objects or Constants.EMPTY strings within the
	 * array are represented by Constants.EMPTY strings.
	 * </p>
	 *
	 * <pre>
	 * StringUtils.join(null, *)                = null
	 ...
	 * @return the joined String, {@code null} if null array input; or the Constants.EMPTY
	 ...
	 * <p>
	 * No delimiter is added before or after the list. Null objects or Constants.EMPTY strings
	 * within the iteration are represented by Constants.EMPTY strings.
	 * </p>
	 *
	 * <p>
	 ...
	 * <p>
	 * No delimiter is added before or after the list. A {@code null} separator is
	 * the same as an Constants.EMPTY String ("").
	 * </p>
	 *
	 * <p>
	 ...
	 *
	 * <p>
	 * A {@code null} source string will return {@code null}. An Constants.EMPTY ("") source
	 * string will return the Constants.EMPTY string. A {@code null} search string will return
	 * the source string.
	 * </p>
	 *
	 * <pre>
	 ...
	 * <p>
	 * A {@code null} source string will return {@code null}. An Constants.EMPTY ("") source
	 * string will return the Constants.EMPTY string. A {@code null} remove string will return
	 * the source string. An Constants.EMPTY ("") remove string will return the source string.
	 * </p>
	 *
	 * <pre>
	...
	public static String remove(final String str, final String remove) {
		...
		return replace(str, remove, Constants.EMPTY, -1);
	}
	...
	public static String removeIgnoreCase(String str, String remove) {
		...
		return replaceIgnoreCase(str, remove, Constants.EMPTY, -1);
	}
	 ...
	 * <p>
	 * A {@code null} source string will return {@code null}. An Constants.EMPTY ("") source
	 * string will return the Constants.EMPTY string.
	 * </p>
	 *
	 * <pre>
	 * StringUtils.remove(null, *)       = null
	...
	public static String remove(final String str, final char remove) {
		if (isEmpty(str) || str.indexOf(remove) == Constants.INDEX_NOT_FOUND) {
			return str;
		}
	 ...
	 * option prepend <code>"(?s)"</code> to the regex. DOTALL is also know as
	...
	public static String removeAll(final String text, final String regex) {
		return replaceAll(text, regex, Constants.EMPTY);
	}
	 ...
	 * DOTALL option prepend <code>"(?s)"</code> to the regex. DOTALL is also know
	...
	public static String removeFirst(final String text, final String regex) {
		return replaceFirst(text, regex, Constants.EMPTY);
	}
	...
	public static String removePattern(final String source, final String regex) {
		return replacePattern(source, regex, Constants.EMPTY);
	}
	...
	private static String replace(String text, String searchString, String replacement, int max, boolean ignoreCase) {
		...
		while (end != Constants.INDEX_NOT_FOUND) {
	 ...
	 *
	 * <p>
	 * A {@code null} string input returns {@code null}. An Constants.EMPTY ("") string input
	 * returns an Constants.EMPTY string.
	 * </p>
	 *
	 * <pre>
	 ...
	 * <p>
	 * A {@code null} string input returns {@code null}. An Constants.EMPTY ("") string input
	 * returns an Constants.EMPTY string. A null or Constants.EMPTY set of search characters returns the
	 * input string.
	 * </p>
	 *
	 * <p>
	 ...
	 *            the size to pad to
	 * @param padStr
	 *            the String to pad with, null or Constants.EMPTY treated as single space
	 * @return right padded String or original String if no padding is necessary,
	 *         {@code null} if null String input
	 */
	 ...
	 *            the int size of new String, negative treated as zero
	 * @param padStr
	 *            the String to pad the new String with, must not be null or Constants.EMPTY
	 * @return centered String, {@code null} if null String input
	 * @throws IllegalArgumentException
	 *             if padStr is {@code null} or Constants.EMPTY
	 */
	 ...
	 * {@link Character#toLowerCase(char)}. No other characters are changed.
	 * </p>
	 *
	 * <p>
	 * For a word based algorithm, see
	 ...
	 *
	 * <p>
	 * A {@code null} or Constants.EMPTY ("") String input returns {@code 0}.
	 * </p>
	 *
	 * <pre>
	...
	public static int countMatches(final CharSequence str, final CharSequence sub) {
		...
		int count = 0;
		int idx = 0;
		while ((idx = CharSequenceUtils.indexOf(str, sub, idx)) != Constants.INDEX_NOT_FOUND) {
			count++;
			idx += sub.length();
		}
		return count;
	 ...
	 *
	 * <p>
	 * {@code null} will return {@code false}. An Constants.EMPTY CharSequence (length()=0)
	 ...
	 *
	 * <p>
	 * {@code null} will return {@code false}. An Constants.EMPTY String (length()=0) will
	 * return {@code false}.
	 * </p>
	 *
	 * <pre>
	 ...
	 * @param str
	 *            the String to check, may be null
	 * @return the passed in String, or the Constants.EMPTY String if it was {@code null}
	 */
	 ...
	 * whitespace, Constants.EMPTY ("") or {@code null}, the value of {@code defaultStr}.
	 * </p>
	 *
	 * <pre>
	 ...
	 *            Constants.EMPTY ("") or {@code null}, may be null
	...
	/**
	 * <p>
	 * Returns either the passed in CharSequence, or if the CharSequence is Constants.EMPTY or
	 ...
	 *            the CharSequence to check, may be null
	 * @param defaultStr
	 *            the default CharSequence to return if the input is Constants.EMPTY ("") or
	 ...
	 * and "ab" is the Constants.EMPTY String and not "c".
	 * </p>
	 *
	 * <p>
	 ...
	 * @return the portion of str2 where it differs from str1; returns the Constants.EMPTY
	...
	public static String difference(final String str1, final String str2) {
		...
		if (at == Constants.INDEX_NOT_FOUND) {
			return Constants.EMPTY;
		}
	...
	public static int indexOfDifference(final CharSequence... css) {
		...
		// handle lists containing all nulls or all Constants.EMPTY strings
		if (allStringsNull || longestStrLen == 0 && !anyStringNull) {
			return Constants.INDEX_NOT_FOUND;
		}

		// handle lists containing some nulls or some Constants.EMPTY strings
		if (shortestStrLen == 0) {
			return 0;
		}
	 ...
	 *         the array; Constants.EMPTY String if the array is null, the elements are all
	...
	public static String getCommonPrefix(final String... strs) {
		...
		if (smallestIndexOfDiff == Constants.INDEX_NOT_FOUND) {
	 ...
	 * https://web.archive.org/web/20120604192456/http://www.merriampark.com/ld.htm</a>
	 * </p>
	 *
	 * <p>
	...
	public static int getLevenshteinDistance(CharSequence s, CharSequence t, final int threshold) {
		...
		// if one string is Constants.EMPTY, the edit distance is necessarily the length of the
		// other
		if (n == 0) {
	  ...
	  public static Collection<String> getStringCollection(String str, String delim) {
	     ...
	     * Duplicate and Constants.EMPTY values are removed.
	 ...
	 *            the CharSequence to check, may be null
	 * @param searchStrings
	 *            the case-sensitive CharSequence prefixes, may be Constants.EMPTY or contain
	 *            {@code null}
		...
		for (int i = 0; i < size; i++) {
			...
			if (!isWhitespace) {
				...
				if (whitespacesCount == 0 && !startWhitespaces) {
					newChars[count++] = Constants.SPACE.charAt(0);
				}
				whitespacesCount++;
			}
		}
	 ...
	 *            the CharSequence to check, may be null
	 * @param searchStrings
	 *            the case-sensitive CharSequences to find, may be Constants.EMPTY or contain
	 *            {@code null}
